...
import RemoteClient.Models.cEvent;

public class EventSenderController implements MouseListener, MouseMotionListener, KeyListener {
    private static EventSenderController _instance;
    ...
    private EventSenderController(Socket imgSoc, int pWidth, int pHeight, int Width, int Height) {
        this.imgSoc = imgSoc;
        try {
    ...
    public static EventSenderController getInstance(int pWidth, int pHeight, int width, int height, Socket imgSoc) {
        if (_instance == null) {
            _instance = new EventSenderController(imgSoc, pWidth, pHeight, width, height);
        }
        new Thread(() -> {
            try {
