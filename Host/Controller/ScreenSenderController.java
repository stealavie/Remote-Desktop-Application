...
public class ScreenSenderController implements Runnable {
    private Socket imgSoc;
    private static ScreenSenderController _instance;
    Robot robot;
    BufferedImage img;
    Rectangle screen;
    ...
    private ScreenSenderController(Socket imgSoc) {
        this.imgSoc = imgSoc;
        try {
    ...
    public static ScreenSenderController getInstance(Socket imgSoc) {
        if (_instance == null) {
            _instance = new ScreenSenderController(imgSoc);
        }
        return _instance;
    }
