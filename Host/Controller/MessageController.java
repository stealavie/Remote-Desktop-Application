...
public class MessageController implements Runnable {
    ...
    private MessageController(Socket msgSoc, JTable chatArea, DefaultTableModel chatModel, String clientName) {
        this.msgSoc = msgSoc;
        try {
    ...
    public static MessageController getInstance(Socket msgSoc, JTable chatArea, DefaultTableModel chatModel, String clientName) {
        if (_instance == null) {
            _instance = new MessageController(msgSoc, chatArea, chatModel, clientName);
        }
        return _instance;
    }
