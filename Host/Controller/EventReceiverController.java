...
import Host.Models.sEvent;

public class EventReceiverController implements Runnable {
    ...
    private static EventReceiverController _instance;
    boolean isRunning = true;

    private EventReceiverController(Socket imgSoc) {
        this.imgSoc = imgSoc;
    }

    public static EventReceiverController getInstance(Socket imgSoc) {
        if (_instance == null) {
            _instance = new EventReceiverController(imgSoc);
        }
        return _instance;
    }
