...
import Host.Controller.FileTransferController;
import Host.Controller.MessageController;

public class chatInterface extends JFrame {
    private MessageController msgInstance;
    private FileTransferController sFileTransferInstance;
    ...
    public chatInterface(Socket msgSoc, Socket fileSoc, String folderPath, String clientName) {
        ...
        msgInstance = MessageController.getInstance(msgSoc, chatArea, chatModel, clientName);
        sFileTransferInstance = FileTransferController.getInstance(fileSoc, folderPath);
        ...
        browseButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    msgInstance.sendMessage("Sent file: " + filePath);
