...
public class Message implements Runnable {
    ...
    private Message(Socket msgSoc, JTable chatArea, DefaultTableModel chatModel, String hostName) {
        this.msgSoc = msgSoc;
        try {
    ...
    public static Message getInstance(Socket msgSoc, JTable chatArea, DefaultTableModel chatModel, String hostName) {
        if (_instance == null) {
            _instance = new Message(msgSoc, chatArea, chatModel, hostName);
        }
        return _instance;
    }
